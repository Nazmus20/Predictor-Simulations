function dxdt=actuatordelaydoubletFixedWingEOM(t,x,tdoublet,devec)
...
%Control Inputs
da=0; %aileron
de=interp1(tdoublet,devec,t)*heaviside(t-tau0)*(1-exp(-1/tau1 *(t-tau0)));
%de=deEq;
dr=0; %rudder
dT=dTEq; %thrust
