...
x3=categorical({'$\theta$({}^\circ)','$q$({}^\circ/s)'});
x3=reordercats(x3,{'$\theta$({}^\circ)','$q$({}^\circ/s)'});
...
set(gca, 'xtick',[1:6],'xticklabel',{'$\begin{array}{c}X_{\rm{SP}}\rm{(m)}\end{array}$',...
                                     '$\begin{array}{c}X_{\rm{KP}}\rm{(m)}\end{array}$',...
                                     '$\begin{array}{c}X_{\rm{EKP}}\rm{(m)}\end{array}$',...
                                     '$\begin{array}{c}Z_{\rm{SP}}\rm{(m)}\end{array}$',...
                                     '$\begin{array}{c}Z_{\rm{KP}}\rm{(m)}\end{array}$',...
                                     '$\begin{array}{c}Z_{\rm{EKP}}\rm{(m)}\end{array}$'});
...
set(gca,'ytick',[1:3],'yticklabel',{'$16^\circ$';'$9^\circ$';'$2^\circ$'});
set(gca, 'xtick',[1:6],'xticklabel',{'$\begin{array}{c}u_{\rm{SP}}\rm{(m/s)}\end{array}$',...
                                     '$\begin{array}{c}u_{\rm{KP}}\rm{(m/s)}\end{array}$',...
                                     '$\begin{array}{c}u_{\rm{EKP}}\rm{(m/s)}\end{array}$',...
                                     '$\begin{array}{c}w_{\rm{SP}}\rm{(m/s)}\end{array}$',...
                                     '$\begin{array}{c}w_{\rm{KP}}\rm{(m/s)}\end{array}$',...
                                     '$\begin{array}{c}w_{\rm{EKP}}\rm{(m/s)}\end{array}$'});
set(gca, 'View', View); set(gca, 'FontSize', fs);
zscale=1.1*0.025;
...
set(gca, 'xtick',[1:6],'xticklabel',{'$\begin{array}{c}\theta_{\rm{SP}}({}^{\circ}) \end{array}$', ...
                                     '$\begin{array}{c}\theta_{\rm{KP}}({}^{\circ}) \end{array}$', ...
                                     '$\begin{array}{c}\theta_{\rm{EKP}}({}^{\circ}) \end{array}$', ...
                                     '$\begin{array}{c}q_{\rm{SP}}({}^{\circ}/s) \end{array}$', ...
                                     '$\begin{array}{c}q_{\rm{KP}}({}^{\circ}/s) \end{array}$', ...
                                     '$\begin{array}{c}q_{\rm{EKP}}({}^{\circ}/s) \end{array}$'});
set(gca, 'View', View); set(gca, 'FontSize', fs);
zscale=1.1*0.25;
...
set(gca, 'xtick',[1:6],'xticklabel',{'$\begin{array}{c}\theta_{\rm{SP}}({}^{\circ})\end{array}$',...
                                     '$\begin{array}{c}\theta_{\rm{KP}}({}^{\circ})\end{array}$',...
                                     '$\begin{array}{c}\theta_{\rm{EKP}}({}^{\circ})\end{array}$',...
                                     '$\begin{array}{c}q_{\rm{SP}}({}^{\circ})\end{array}$',...
                                     '$\begin{array}{c}q_{\rm{KP}}({}^{\circ})\end{array}$',...
                                     '$\begin{array}{c}q_{\rm{EKP}}({}^{\circ})\end{array}$'});
set(gca, 'View', View); set(gca, 'FontSize', fs);
zscale=1.1*0.25;
text(1-0.25,1, thetaqdata(1,1)+zscale,sprintf('%0.1f',thetaqdata(1,1)),'HorizontalAlignment','left', 'FontSize', fs)
text(1-0.25,2, thetaqdata(2,1)+zscale,sprintf('%0.1f',thetaqdata(2,1)),'HorizontalAlignment','left', 'FontSize', fs)
