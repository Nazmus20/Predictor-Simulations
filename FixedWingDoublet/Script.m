%Script to run the Fixed Wing wings level flight subject to some doublet
%input
...
plot(Sim.t_vec-Sim.in_del-Sim.out_del-Sim.Ts, del_actual_states_NL(3,:), 'k-', t_KP2, predicted_states_KP2(3,:), 'r-', t_KP2, predicted_states_SP(3,1:end-1), 'b-')
