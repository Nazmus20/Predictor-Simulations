function [dx, ucntrl] = LinearMultirotorTrajectoryGenerator(tdum, ...
...
% input is u=uD - Klqr*(x - xD) which replaces the inputs u in f(x,u)
...
%for hover, xSS = 0;
xSS = zeros(12,1); uSS = val(1:4); x_dotSS = zeros(12,1);
