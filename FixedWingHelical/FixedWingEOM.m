function dxdt=FixedWingEOM(t,x,tmaneuver,devec,davec,drvec,drpsvec, Ts)
...
if t>=tmaneuver(1)+Ts
    ...
    da=interp1(tmaneuver+Ts,davec,t);
    dr=interp1(tmaneuver+Ts,drvec,t);
    drps=interp1(tmaneuver+Ts,drpsvec,t);
else
    de = devec(1);
    da = davec(1);
    dr = drvec(1);
