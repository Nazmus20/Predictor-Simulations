function dx_vecdt = MultirotorEOMActual(Param)

% MultirotorEOMActual.m
%
% "Actual" dynamic EOMs of a multirotor aircraft adopted from
...
% here is used to distinguish from the "modeled" EOMs. The "actual" EOM is
% used to obtain outputs for the simulation. The "modeled" EOMs are used to
% predict the system dynamics. This demonstrates the effect of different
% predictors when the model and the actual values are different.
...
epsilon = .001;  
%Aerodynamic forces and moments, having a drag model for now
